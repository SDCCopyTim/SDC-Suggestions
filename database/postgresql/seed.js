...
const insertData = () => {
  ...
  camp.forEach((camps) => {
    ...
    const queryString = `INSERT INTO camp (name, property, state, responses, rating, img_url, map_url) VALUES ('${name}', '${property}', '${state}', ${responses}, ${rating}, '${img_url}', '${map_url}');`;
